...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServiceTicket.renewed'
        db.add_column(u'cas_serviceticket', 'renewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TicketRequest.renewed'
        db.add_column(u'cas_ticketrequest', 'renewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ServiceTicket.renewed'
        db.delete_column(u'cas_serviceticket', 'renewed')

        # Deleting field 'TicketRequest.renewed'
        db.delete_column(u'cas_ticketrequest', 'renewed')
