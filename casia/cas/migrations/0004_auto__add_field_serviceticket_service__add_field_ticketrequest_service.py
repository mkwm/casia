...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServiceTicket.service'
        db.add_column(u'cas_serviceticket', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cas.Service']),
                      keep_default=False)

        # Adding field 'TicketRequest.service'
        db.add_column(u'cas_ticketrequest', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cas.Service']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ServiceTicket.service'
        db.delete_column(u'cas_serviceticket', 'service_id')

        # Deleting field 'TicketRequest.service'
        db.delete_column(u'cas_ticketrequest', 'service_id')
