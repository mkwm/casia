...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'cas_ticketrequest')

        # Adding field 'CASLoginHistoryEntry.renewed'
        db.add_column(u'cas_casloginhistoryentry', 'renewed',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'cas_ticketrequest', (
            ('renewed', self.gf('django.db.models.fields.BooleanField')()),
        ...
        db.send_create_signal(u'cas', ['TicketRequest'])

        # Deleting field 'CASLoginHistoryEntry.renewed'
        db.delete_column(u'cas_casloginhistoryentry', 'renewed')
    ...
    models = {
        ...
        u'cas.casloginhistoryentry': {
            'Meta': {'object_name': 'CASLoginHistoryEntry', '_ormbases': [u'core.LoginHistoryEntry']},
            u'loginhistoryentry_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.LoginHistoryEntry']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'cas.sharedsecret': {
            ...
            'service': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'cas_shared_secret'", 'unique': 'True', 'primary_key': 'True', 'to': u"orm['core.Service']"})
        },
        ...
        u'core.loginhistoryentry': {
            'Meta': {'object_name': 'LoginHistoryEntry'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'service': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['core.Service']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'core.service': {
