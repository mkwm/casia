...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cas_serviceticket', (
            ('ticket', self.gf('django.db.models.fields.CharField')(max_length=256, primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('consumed_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ...
            ('pgt', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['cas.ProxyGrantingTicket'])),
        ))
        db.send_create_signal(u'cas', ['ServiceTicket'])
        ...
        # Adding model 'ServiceURL'
        db.create_table(u'cas_serviceurl', (
        ...
        db.send_create_signal(u'cas', ['ServiceURL'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'cas_serviceticket')

        # Deleting model 'TicketRequest'
        db.delete_table(u'cas_ticketrequest')

        # Deleting model 'ServiceURL'
        db.delete_table(u'cas_serviceurl')
