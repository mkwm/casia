...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CASLoginHistoryEntry'
        db.create_table(u'cas_casloginhistoryentry', (
            (u'loginhistoryentry_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.LoginHistoryEntry'], unique=True, primary_key=True)),
            ('used_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'cas', ['CASLoginHistoryEntry'])


    def backwards(self, orm):
        # Deleting model 'CASLoginHistoryEntry'
        db.delete_table(u'cas_casloginhistoryentry')
