...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServicePolicy.allow_single_logout'
        db.add_column(u'server_servicepolicy', 'allow_single_logout',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ServicePolicy.allow_single_logout'
        db.delete_column(u'server_servicepolicy', 'allow_single_logout')
